...
\usepackage{cite,enumerate,float} %подключаем нужные пакеты расширений
...
\titlespacing*{\chapter}{\parindent}{*5}{18pt}
\titlespacing*{\section}{\parindent}{*5}{18pt}
